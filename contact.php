        ...
        <div class="content">
            ...
            <div class="container my-5">
                    ...
                    <div class="col">
                        ...
                        <section class="mb-4">
                            <p class="p-4 font-weight-bold shadow-sm"
                                ...
                                delegações nos distritos da província da Zambézia (Moçambique) com fim de alargar as
                                suas
                ...
                <div class="alert alert-danger alert-dismissible fade show mt-0" role="alert" id="bsalert-fail">
                    <p><i class="fas fa-times fa-2x"></i> Opps! Não foi possível enviar a sua mensagem. Por favor
                        verifique
                    ...
                    <div class="col-sm-12 col-md-6">
                        <section id="contact">
                            ...
                            <p>
                                ...
                                <a href="mailto:fafaabelmatosm@gmail.com"
                                    class="global-link ">fafaabelmatosm@gmail.com</a><br />
                                <span class="font-weight-bold">Tel.:</span> <a class="global-link "
                                    href="tel:+258840183687">+258
                                    840183687</a><br />

                                <span class="font-weight-bold">Localização: </span><a target="_blank"
                                    href="https://pt.wikipedia.org/wiki/Quelimane" class="global-link ">Quelimane </a> -
                                <a target="_blank" href="https://pt.wikipedia.org/wiki/Mo%C3%A7ambique"
                                    class="global-link ">Moçambique</a>
                                <br />
                ...
                <div style="font-size: 1.2em;" class="text-center">
                    <p>
                        ...
                        <a href="about-us.php#about-values">Valores da associação</a> <span
                            class="special-character">|</span> <a class="  "
                            href="about-us.php#about-objectives">Objetivos
                            da associação</a> <span class="special-character">|</span> <a class="  "
                            href="donation.php">Doe
                            para associação</a>
                    </p>
                </div>
